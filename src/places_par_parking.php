...
<?php include("template/header.php"); ?>
 ...
 <?php include("template/navbar.php"); ?>
   <h2 class="center">Nombre places par parkings</h2>
     <?php
    include "connect.php"; /* Le fichier connect.php contient les identifiants de connexion */
     ...
     <div class="row">
            <table class="col s8 m8 offset-s2 offset-m2">
                <tr>
              <th>Nom Parking</th>
              <th>Nombre total place</th>
                </tr>
          <?php
                $requete = file_get_contents("sql/requests/consultations/nb_place_par_parking.sql");
                ...
                if($res) {
                    /* ... on récupère un tableau stockant le résultat */
                      while ($parking =  pg_fetch_assoc($res)) {
                          ...
                          echo '<td>'.$parking['place_par_parking'].'</td>';
                          echo '</tr>'."\n";
                      }
